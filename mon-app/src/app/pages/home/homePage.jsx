...
function HomePage() {
  ...
  useEffect(() => {
      ...
      const dummyData = [
          { title: "Article 1", image: "https://www.leparisien.fr/resizer/XEtkllOP69v9JTN3zmcPCA2iFlA=/932x582/cloudfront-eu-central-1.images.arcpublishing.com/lpguideshopping/WVEBLSJVIMDGHKFBH6EW6WFXMU.jpg", summary: "Résumé 1" },
